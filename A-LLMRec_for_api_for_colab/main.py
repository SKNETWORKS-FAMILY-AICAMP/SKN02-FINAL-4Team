...
if __name__ == "__main__":
    ...
    # 추가된 부분: 훈련 재개를 위한 명령행 인자
    parser.add_argument('--start_epoch', type=int, default=1, help='훈련을 시작할 에포크 번호')
    parser.add_argument('--phase1_epoch', type=int, default=10, help='스테이지 1에서 로드할 에포크 번호')
